...
$queryString="create table user(ID VARCHAR(50) PRIMARY KEY,name char(50),password char(50),level enum('0','1','2'))ENGINE=MyISAM DEFAULT CHARSET=utf8";
mysqli_query($link,$queryString);
...
//$queryString="insert into user(id,name,password,level)VALUES ('1','mike','100200','0')"; //user基础插入语句
//mysqli_query($link,$queryString);
